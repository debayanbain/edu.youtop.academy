...
const FeaturesGrid = () => {
  return (
    <section className="bg-brutal-yellow/20 py-16 border-y-3 border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {features.map((item, idx) => (
            <div
              key={idx}
              className="card-brutal bg-card p-6 flex flex-col items-center justify-center gap-3 cursor-pointer"
            >
